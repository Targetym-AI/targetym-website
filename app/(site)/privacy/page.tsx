...
const toc = [
  { id: 'article-1', k: '1', label: 'Qui traite vos données ?' },
  { id: 'article-2', k: '2', label: 'Quelles données collectons-nous et pourquoi ?' },
  { id: 'article-3', k: '3', label: 'Bases légales des traitements' },
  { id: 'article-4', k: '4', label: 'Intelligence Artificielle et données personnelles' },
  { id: 'article-5', k: '5', label: 'Durée de conservation' },
  { id: 'article-6', k: '6', label: 'Qui accède à vos données ?' },
  { id: 'article-7', k: '7', label: 'Transferts de données hors du Sénégal' },
  { id: 'article-8', k: '8', label: 'Cookies et traceurs' },
  { id: 'article-9', k: '9', label: 'Vos droits sur vos données personnelles' },
  { id: 'article-10', k: '10', label: 'Comment protégeons-nous vos données ?' },
  { id: 'article-11', k: '11', label: 'Personnes mineures' },
  { id: 'article-12', k: '12', label: 'Liens vers des sites tiers' },
  { id: 'article-13', k: '13', label: 'Modifications de la Politique' },
  { id: 'article-14', k: '14', label: 'Nous contacter' },
];
...
export default function PrivacyPage() {
  return (
    <LegalPage
      current="/privacy"
      eyebrow="Targetym AI · Le SIRH optimisé IA qui fait 50% du travail du DRH"
      title={<>Politique de Protection <span>de la Vie Privée</span></>}
      updated={lastUpdated}
      frame="Loi n°2008-12 du Sénégal"
      contact="privacy@targetym.ai"
      toc={toc}
    >
      ...
      <h2 id="article-1"><small>Article 1</small>Qui traite vos données ?</h2>
      <p>
      ...
      <h2 id="article-2"><small>Article 2</small>Quelles données collectons-nous et pourquoi ?</h2>
      ...
      <h2 id="article-3"><small>Article 3</small>Bases légales des traitements</h2>
      ...
      <h2 id="article-4"><small>Article 4</small>Intelligence Artificielle et données personnelles</h2>
      ...
      <h2 id="article-5"><small>Article 5</small>Durée de conservation</h2>
      ...
      <h2 id="article-6"><small>Article 6</small>Qui accède à vos données ?</h2>
      ...
      <h2 id="article-7"><small>Article 7</small>Transferts de données hors du Sénégal</h2>
      <p>
      ...
      <h2 id="article-8"><small>Article 8</small>Cookies et traceurs</h2>
      ...
      <h2 id="article-9"><small>Article 9</small>Vos droits sur vos données personnelles</h2>
      ...
      <h2 id="article-10"><small>Article 10</small>Comment protégeons-nous vos données ?</h2>
      ...
      <h2 id="article-11"><small>Article 11</small>Personnes mineures</h2>
      <p>
      ...
      <h2 id="article-12"><small>Article 12</small>Liens vers des sites tiers</h2>
      ...
      <h2 id="article-13"><small>Article 13</small>Modifications de la Politique</h2>
      <p>
      ...
      <h2 id="article-14"><small>Article 14</small>Nous contacter</h2>
      <p>
