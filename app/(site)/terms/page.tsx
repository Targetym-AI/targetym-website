...
const toc = [
  { id: 'identite', label: 'Mentions Légales' },
  { id: 'partie-i', k: 'I', label: "Conditions d'utilisation du site internet" },
  { id: 'partie-ii', k: 'II', label: "Conditions d'utilisation du logiciel Targetym AI" },
  { id: 'partie-iii', k: 'III', label: 'Dispositions communes' },
...
export default function TermsPage() {
  return (
    <LegalPage
      ...
      title={<>Mentions Légales <span>&amp; CGU</span></>}
      updated={lastUpdated}
    ...
    >
      ...
      <h2 id="identite"><small>Identité</small>Mentions Légales</h2>
      <p>
      ...
      <h2 id="partie-i"><small>Partie I</small>Conditions d&apos;utilisation du site internet</h2>
      ...
      <h2 id="partie-ii"><small>Partie II</small>Conditions d&apos;utilisation du logiciel Targetym AI</h2>
      ...
      <h2 id="partie-iii"><small>Partie III</small>Dispositions communes</h2>
