...
const faqs = [
  ...
  },
  {
    ...
    answer: "Oui, nous offrons un essai gratuit de 15 jours avec accès complet au plan Entreprise (jusqu'à 100 employés). Aucun paiement requis pour commencer.",
  },
  {
      ...
      <section className="bg-gradient-to-b from-primary-50 to-white pt-16 pb-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
          <div className="inline-flex items-center px-4 py-2 bg-primary-100 text-primary-700 rounded-full text-sm font-medium mb-6">
            Essai gratuit 15 jours — aucune carte bancaire requise
          </div>
