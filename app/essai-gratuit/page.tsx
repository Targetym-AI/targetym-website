...
export default function EssaiGratuitPage() {
  ...
  return (
    <div>
      ...
      <section className="py-8 bg-white border-y border-gray-100">
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
          <div className="grid sm:grid-cols-3 gap-6 text-center">
            {[
              { icon: Users, stat: '500+', label: 'Entreprises accompagnées' },
              { icon: Clock, stat: '50%', label: 'Du temps RH automatisé' },
              { icon: Star, stat: '4.9/5', label: 'Satisfaction client' },
      ...
      {/* Qualification Form */}
      <section className="py-16 bg-gray-50" id="formulaire">
        <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
